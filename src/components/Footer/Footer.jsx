...
const Footer = () => {
    ...
    return (
        <div className={`mt-20 ${isModeDark ? 'bg-[#48ac90a7]' : 'bg-[#e4f3f0]'}`}>
            <footer className="w-11/12 p-5 sm:py-10 mx-auto flex flex-col sm:flex-row gap-5 sm:items-center justify-between">
                ...
                <div className='sm:w-1/4 flex flex-col sm:justify-end sm:items-end'>
                    ...
                    <Link to="https://github.com/ashis263"><FaSquareGithub className={`${isModeDark ? 'text-gray-800' : ''}`} /></Link>
                    <Link to="https://www.linkedin.com/in/ashis263/"><FaLinkedin className={`${isModeDark ? 'text-blue-900' : 'text-blue-900'}`} /></Link>
                    <Link to="https://www.facebook.com/ashis263/"><FaFacebookSquare className={`${isModeDark ? 'text-blue-800' : 'text-sky-700'}`} /></Link>
                    </div>
                </div>
            </footer>
            <hr />
