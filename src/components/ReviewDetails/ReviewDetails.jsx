        ...
        <div className="w-11/12 mx-auto rounded-xl p-5 sm:p-10 shadow-primary shadow-lg">
            ...
            <div className="space-y-5 sm:flex justify-center items-center">
                ...
                <div className="w-full sm:w-3/5 lg:w-1/2 flex flex-col items-center sm:block">
                    <p className="text-gray-300 text-center sm:text-start w-4/5">{review.review}</p>
                    <div className="flex gap-5 items-center">
                        <ReactStars {...rating} />
                        <p className="py-1 px-3 bg-gray-400 rounded-lg border">{review.rating}.0</p>
                    </div>
                    <div className="flex gap-10 font-semibold text-gray-300">
                    ...
                    <button onClick={handleWatchlist} className={user ? "btn btn-xs sm:btn-sm hover:bg-primary border-none bg-primary text-gray-300 mt-5" : "hidden"}>Add to watchlist</button>
